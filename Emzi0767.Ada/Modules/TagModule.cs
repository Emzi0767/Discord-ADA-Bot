...
namespace Emzi0767.Ada.Modules
{
    ...
    public sealed class TagModule : BaseCommandModule
    {
        ...
        [Command("create"), Aliases("make"), Description("Creates a new tag."), NotDisabled]
        ...
        [Command("delete"), Aliases("remove"), Description("Deletes a tag."), NotDisabled]
        ...
        [Command("force_delete"), Aliases("force_remove"), Description("Forcefully deletes a tag. This is meant for moderators."), RequireUserPermissions(Permissions.ManageChannels), NotDisabled]
        ...
        [Command("edit"), Aliases("modify"), Description("Edits a tag."), NotDisabled]
        ...
        [Command("force_edit"), Aliases("force_modify"), Description("Forcefully edits a tag. This is meant for moderators."), RequireUserPermissions(Permissions.ManageChannels), NotDisabled]
        ...
        [Command("history"), Description("Views edit history for a tag."), NotDisabled]
        ...
        [Command("view_edit"), Description("Views a tag's specific revision."), NotDisabled]
        ...
        [Command("dump"), Aliases("raw"), Description("Dumps tag's contents in raw form."), NotDisabled]
        ...
        [Command("info"), Description("Views information about a tag."), NotDisabled]
        ...
        [Command("unhide"), Description("Unhides a tag, which makes it appear in tag listings."), NotDisabled]
        ...
        [Command("force_unhide"), Description("Forcefully unhides a tag. This is meant for moderators."), RequireUserPermissions(Permissions.ManageChannels), NotDisabled]
        ...
        [Command("hide"), Description("Hides a tag, which prevents it from being displayed in tag listings."), NotDisabled]
        ...
        [Command("force_hide"), Description("Forcefully hides a tag. This is meant for moderators."), RequireUserPermissions(Permissions.ManageChannels), NotDisabled]
        ...
        [Command("changetype"), Description("Changes type of a tag between guild and channel."), NotDisabled]
        ...
        [Command("force_changetype"), Description("Forcibly changes type of a tag. This is meant for moderators."), RequireUserPermissions(Permissions.ManageMessages), NotDisabled]
        ...
        [Command("list"), Description("Lists tags, optionally specifying a search query."), NotDisabled]
